...
import com.easyzaki.hurricanevpn.Packet.TCPHeader;
import com.easyzaki.hurricanevpn.TCB.TCBStatus;
...
public class TCPOutput implements Runnable
{
    ...
    private HurricaneVpnService vpnService;
    ...
    public TCPOutput(ConcurrentLinkedQueue<Packet> inputQueue, ConcurrentLinkedQueue<ByteBuffer> outputQueue,
                     Selector selector, HurricaneVpnService vpnService)
    {
